...
{
    /// <summary>
    /// ClientTypeRepository provides basic CRUD operations inherited from BaseRepository.
    /// </summary>
    public class ClientTypeRepository : BaseRepository<ClientType>, IClientTypeRepository
    {
        ...
        #region Constructor
        public ClientTypeRepository(IUnitOfWork uow, ILogger logger) : base(uow, logger)
        {
            _logger = logger;
            _uow = uow;
            _disposed = false;
